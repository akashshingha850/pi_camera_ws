 ...
 *
 * Image Processing Algorithm data serializer for mali-c55
 *
...
template<>
class IPADataSerializer<ipa::mali_c55::IPAConfigInfo>
{
public:
	static std::tuple<std::vector<uint8_t>, std::vector<SharedFD>>
	serialize(const ipa::mali_c55::IPAConfigInfo &data,
	...
	static ipa::mali_c55::IPAConfigInfo
	deserialize(std::vector<uint8_t> &data,
		    ControlSerializer *cs)
	{
		return IPADataSerializer<ipa::mali_c55::IPAConfigInfo>::deserialize(data.cbegin(), data.cend(), cs);
	}
	...
	deserialize(std::vector<uint8_t>::const_iterator dataBegin,
		    ...
		    ControlSerializer *cs)
	{
		ipa::mali_c55::IPAConfigInfo ret;
	...
	deserialize(std::vector<uint8_t>::const_iterator dataBegin,
		    ...
		    ControlSerializer *cs = nullptr)
	{
		return IPADataSerializer<ipa::mali_c55::IPAConfigInfo>::deserialize(dataBegin, dataEnd, cs);
	}
};
